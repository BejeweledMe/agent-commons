...
| [0021](0021-objective-blueprint-application-provenance.md) | Proposed to coordinator | Canonical objective links and immutable blueprint-application provenance; board frames may reference an application but remain operational state. |
