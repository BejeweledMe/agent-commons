...
| [`claude_architecture_improvement_review.md`](../archive/reviews/claude_architecture_improvement_review.md) | Provenance/workspace evidence; tracked historical evidence | `61e49c44b1b69b4294a93b72912030f050118067d3c12d3255d7ae3278c0c788` | 25-Aug review material; hash records bytes, not authorship. |
| [`codex_architecture_improvement_review.md`](../archive/reviews/codex_architecture_improvement_review.md) | Rewritten review proposal; tracked historical evidence | `2d84d3cf10571dd082a18c38d2e90190695317bcb74d7c131ebf2054c9f46aa8` | Byte-distinct current Codex working copy; not canonical. |
...
The original path remains retrievable in that Git revision.

The two remaining registered review artifacts moved byte-for-byte from the
repository root to `docs/archive/reviews/` on 2026-09-18 in the documentation
consolidation; their SHA-256 values above are unchanged and their former root
paths remain retrievable in Git history before that move.
