...
Agent Commons is a web application for directing a team of AI agents. It keeps
the work visible from the first task to the final human decision: who is doing
what, what is waiting, what has been reviewed, and what still needs you.
...
[repository README](../../README.md#technical-and-operator-documentation).
