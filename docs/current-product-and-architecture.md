...
**Функциональная граница снимка:** `f998e33` (`Introduce Frozen Decision Projection Record`),
24 августа 2026 года. После этой границы в ветке были и документационные, и поведенческие
изменения, поэтому этот файл нельзя использовать как описание текущего checkout без новой
проверки.
